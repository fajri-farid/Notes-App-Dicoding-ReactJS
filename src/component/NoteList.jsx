  ...
  <div className="p-10">
    ...
    <div className="flex flex-wrap justify-normal">
      {props.notes.map((note) => (
        <div
          key={note.id}
          className="border p-6 m-2 w-full sm:w-5/12 lg:w-[30%] h-80 flex flex-col justify-between rounded-lg shadow-lg"
        >
          <div>
          ...
          <div className="mt-4 flex justify-between">
            <Button
              ...
              className="bg-blue-500 text-white hover:bg-blue-600 w-5/12 py-2"
            >
              Arsipkan
            </Button>
            <Button
